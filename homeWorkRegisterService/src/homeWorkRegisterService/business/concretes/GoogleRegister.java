...
public class GoogleRegister implements RegisterService{
	...
	public GoogleRegister(UserDao userDao, VerificationService verificationService) {
		super();
	...
	public void register(User user) {
		...
		userDao.add(user);
		System.out.println(user.getEmail() + " Adresine doðrulama mailiniz gönderildi (Google kayit)");
	}
